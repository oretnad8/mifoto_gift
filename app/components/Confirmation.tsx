...
const Confirmation = ({ cartItems, onConfirm, onBack }) => {
  const [customerName, setCustomerName] = useState('');
  const [errors, setErrors] = useState({});

  // Solo un kiosco habilitado - el que corresponde al QR escaneado
  const selectedKiosk = {
    id: 'main-kiosk',
    name: 'Kiosco MiFoto - Principal',
    address: 'Ubicación del kiosco escaneado'
  };
            ...
            <div className="bg-gradient-to-r from-[#CEDFE7] to-[#FCF4F3] rounded-2xl p-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white rounded-xl border-2 transition-colors duration-200 text-sm ${
                    errors.name 
