...
const CategoryScreen = ({ onCategorySelect }) => {
    ...
    <div className="min-h-screen bg-white px-4 sm:px-8 py-6 sm:py-8">
      <div className="max-w-6xl mx-auto text-center h-full flex flex-col justify-between">
        ...
        <div className="flex justify-center flex-1 items-center py-8">
          <div
            className={`relative overflow-hidden rounded-3xl cursor-pointer transition-all duration-300 transform bg-gradient-to-br from-[#CEDFE7] to-[#FCF4F3] ${
              hoveredCard ? 'scale-105 shadow-2xl' : 'shadow-xl hover:shadow-2xl hover:scale-105'
            }`}
          ...
          >
            <div className="p-6 sm:p-8 h-full flex flex-col items-center justify-center text-center relative">
              {/* Icono */}
              <div className={`w-16 sm:w-20 h-16 sm:h-20 rounded-full flex items-center justify-center mb-4 sm:mb-6 transition-all duration-300 bg-[#D75F1E] text-white ${
                hoveredCard ? 'scale-110 shadow-xl' : ''
              }`}>
              ...
              {/* Call to action */}
              <div className={`bg-white/80 rounded-2xl px-4 sm:px-6 py-2 sm:py-3 transition-all duration-300 ${
                hoveredCard ? 'bg-white shadow-lg' : ''
              }`}>
